...
public class ExamAdapter extends BaseAdapter {
    ...
    public ExamAdapter(ArrayList<TestPaper> testPapers,Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            //调用视图填充器
            convertView = LayoutInflater.from(this.context).inflate(R.layout.exam_listview_item, null);
